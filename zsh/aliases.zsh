...
alias ralph-bugbot='cc "/ralph-loop:ralph-loop \"Use ralph bugbot skill. Look for bugbot feedback and address feedback until bugbot stops reporting issues.\" --completion-promise \"BUGBOT RESOLVED\" --max-iterations 10"'
