...
alias rbb='claude "/ralph-loop:ralph-loop \"Use ralph bugbot skill. Look for bugbot feedback and address feedback until bugbot stops reporting issues.\" --max-iterations 10 --completion-promise \"BUGBOT RESOLVED\""'
