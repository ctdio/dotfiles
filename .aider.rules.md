...
When editing files, make sure you pay special attention to the types and parameters being changed. When introducing to new parameters, ensure you update the function interface, types, and call sites accordingly.
